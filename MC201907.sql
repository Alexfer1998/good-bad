...
)select a.* case when b.DiasAtraso > 8 or c.Diasatraso > 8 then 'MAL CLIENTE'
ELSE 'BUEN CLIENTE' END [FlagCliente]
 From ModeloCliente201906 a left join tmpMora3m b on b.id_cuenta = a.idencuenta
